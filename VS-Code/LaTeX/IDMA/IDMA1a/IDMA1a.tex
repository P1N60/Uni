...
\begin{lstlisting}
sorted := True          //1 running time unit
for i := 1 upto n-1     //n running time units
    if (A[i] > A[i+1])  //1 running time unit
        sorted := False //1 running time unit
if (sorted)             //1 running time unit
    return "success"    //1 running time unit
else                    //1 running time unit
    return "failure"    //1 running time unit
\end{lstlisting}
...
\begin{lstlisting}
for i := 1 upto n {             //n running time units
    if (A[i] < 1 or A[i] > n)   //1 running time unit
        return "failure"        //1 running time unit
}
i := 1                          //1 running time unit
found := -1                     //1 running time unit
while (i <= n and found < 0) {  //n running time units
    for j := 1 upto n {         //n running time units
        B[j] := false           //1 running time unit
    }
    j := 1                      //1 running time unit
    while (B[j] == false) {     
        B[j] := true
        j := A[j]
    }
