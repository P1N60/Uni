...
Neders i min "diku.py" fil, har jeg lavet en funktion og skrevet nogle test cases, der gør brug af input partitioning, for at finde inputs, der udløser en specification violation.\\
