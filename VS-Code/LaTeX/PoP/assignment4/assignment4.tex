...
\subsubsection*{Fixed Value}
    \begin{itemize}
        \item cardNumber: Denne variabel bruges til at holde det aktuelle kortnummer. Selvom værdien ændres i løbet af programmet, har den en fast opdateringslogik (inkrementering med 1).
    \end{itemize}
